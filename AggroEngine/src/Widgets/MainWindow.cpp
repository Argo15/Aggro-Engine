...
void MainWindow::open()
{
	...
	{
		shared_ptr<Scene> scene = Scene::deserialize(chunk.get(), m_context->getResources(), m_context->getMeshImporter());
		if (scene)
		{
			m_context->setScene(scene);
		}
...
shared_ptr<Scene> MainWindow::_loadDefaultScene()
{
	...
	{
		return Scene::deserialize(chunk.get(), m_context->getResources(), m_context->getMeshImporter());
	}
